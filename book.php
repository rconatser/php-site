<?php $pgtitle='Book'; include '_top.php'; ?>
...
<section class="padding-40">
    ...
    <form id="book" action="#" type="post">
        ...
        <div>
            <label for="cruise">Select Your Cruise</label>
...
<?php include '_jslinks.php'; ?>

<?php include '_slick.php'; ?>

<?php include '_closing.php'; ?>